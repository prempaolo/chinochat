 ...
 * {@link PendingRequestsFragment.OnFragmentInteractionListener} interface
...
public class PendingRequestsFragment extends Fragment {
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onPendingRequestsFragmentInteraction(uri);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onPendingRequestsFragmentInteraction(Uri uri);
    }
}
